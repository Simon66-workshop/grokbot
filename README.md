...
菜单栏托盘是**活的 22px 脸**。右键托盘：**显示 / 隐藏、场景、S/M/L、静音、Agents Watch、Auto Work、开机启动、退出。** 菜单栏 GrokBot 下拉里也可以勾 **Mute**。单实例。右键球体可隐藏。
...
- **Agents Watch**：盯本地 AI 线程（Codex、Claude Code、Cursor、Gemini CLI、Amp、Goose、OpenCode、Aider、Copilot CLI）。它在跑会思考，等你点头会叫一声并弹系统通知，跑完会高兴一下。只读会话状态，不上传内容、不碰密钥。面板上可关
